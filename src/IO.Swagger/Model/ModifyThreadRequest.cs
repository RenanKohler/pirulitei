...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyThreadRequest :  IEquatable<ModifyThreadRequest>, IValidatableObject
    {
        /// <summary>
        ...
        {
            return this.Equals(input as ModifyThreadRequest);
        }

        /// <summary>
        /// Returns true if ModifyThreadRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyThreadRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyThreadRequest input)
        {
            if (input == null)
                return false;

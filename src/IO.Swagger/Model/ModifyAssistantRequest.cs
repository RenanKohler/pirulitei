...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ModifyAssistantRequest :  IEquatable<ModifyAssistantRequest>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="fileIds">A list of [File](/docs/api-reference/files) IDs attached to this assistant. There can be a maximum of 20 files attached to the assistant. Files are ordered by their creation date in ascending order. If a file was previosuly attached to the list but does not show up in the list, it will be deleted from the assistant.  (default to []).</param>
        /// <param name="metadata">Set of 16 key-value pairs that can be attached to an object. This can be useful for storing additional information about the object in a structured format. Keys can be a maximum of 64 characters long and values can be a maxium of 512 characters long. .</param>
        public ModifyAssistantRequest(AnyOfModifyAssistantRequestModel model = default(AnyOfModifyAssistantRequestModel), string name = default(string), string description = default(string), string instructions = default(string), List<OneOfModifyAssistantRequestToolsItems> tools = default, List<string> fileIds = default, Object metadata = default(Object))
        {
            this.Model = model;
            this.Name = name;
        ...
        /// </summary>
        /// <value>A list of [File](/docs/api-reference/files) IDs attached to this assistant. There can be a maximum of 20 files attached to the assistant. Files are ordered by their creation date in ascending order. If a file was previosuly attached to the list but does not show up in the list, it will be deleted from the assistant. </value>
        ...
        {
            return this.Equals(input as ModifyAssistantRequest);
        }

        /// <summary>
        /// Returns true if ModifyAssistantRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of ModifyAssistantRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ModifyAssistantRequest input)
        {
            if (input == null)
                return false;

...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class AssistantFileObject :  IEquatable<AssistantFileObject>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="_object">The object type, which is always &#x60;assistant.file&#x60;. (required).</param>
        ...
        public AssistantFileObject(string id = default(string), ObjectEnum _object = default(ObjectEnum), int? createdAt = default(int?), string assistantId = default(string))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for AssistantFileObject and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (_object == null)
            {
                throw new InvalidDataException("_object is a required property for AssistantFileObject and cannot be null");
            }
            else
            {
            ...
            if (createdAt == null)
            {
                throw new InvalidDataException("createdAt is a required property for AssistantFileObject and cannot be null");
            }
            else
            {
            ...
            if (assistantId == null)
            {
                throw new InvalidDataException("assistantId is a required property for AssistantFileObject and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as AssistantFileObject);
        }

        /// <summary>
        /// Returns true if AssistantFileObject instances are equal
        /// </summary>
        /// <param name="input">Instance of AssistantFileObject to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(AssistantFileObject input)
        {
            if (input == null)
                return false;

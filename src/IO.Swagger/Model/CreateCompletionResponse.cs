...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateCompletionResponse :  IEquatable<CreateCompletionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        /// <param name="_object">The object type, which is always \&quot;text_completion\&quot; (required).</param>
        /// <param name="usage">usage.</param>
        public CreateCompletionResponse(string id = default(string), List<CreateCompletionResponseChoices> choices = default(List<CreateCompletionResponseChoices>), int? created = default(int?), string model = default(string), string systemFingerprint = default(string), ObjectEnum _object = default(ObjectEnum), CompletionUsage usage = default(CompletionUsage))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for CreateCompletionResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (choices == null)
            {
                throw new InvalidDataException("choices is a required property for CreateCompletionResponse and cannot be null");
            }
            else
            {
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for CreateCompletionResponse and cannot be null");
            }
            else
            {
            ...
            if (model == null)
            {
                throw new InvalidDataException("model is a required property for CreateCompletionResponse and cannot be null");
            }
            else
            {
                this.Model = model;
            ...
            if (_object == null)
            {
                throw new InvalidDataException("_object is a required property for CreateCompletionResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreateCompletionResponse);
        }

        /// <summary>
        /// Returns true if CreateCompletionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateCompletionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateCompletionResponse input)
        {
            if (input == null)
                return false;

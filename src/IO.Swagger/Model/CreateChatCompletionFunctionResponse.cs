...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateChatCompletionFunctionResponse :  IEquatable<CreateChatCompletionFunctionResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public CreateChatCompletionFunctionResponse(string id = default(string), List<CreateChatCompletionFunctionResponseChoices> choices = default(List<CreateChatCompletionFunctionResponseChoices>), int? created = default(int?), string model = default(string), string systemFingerprint = default(string), ObjectEnum _object = default(ObjectEnum), CompletionUsage usage = default(CompletionUsage))
        {
            // to ensure "id" is required (not null)
            if (id == null)
            {
                throw new InvalidDataException("id is a required property for CreateChatCompletionFunctionResponse and cannot be null");
            }
            else
            {
                this.Id = id;
            ...
            if (choices == null)
            {
                throw new InvalidDataException("choices is a required property for CreateChatCompletionFunctionResponse and cannot be null");
            }
            else
            {
            ...
            if (created == null)
            {
                throw new InvalidDataException("created is a required property for CreateChatCompletionFunctionResponse and cannot be null");
            }
            else
            {
            ...
            if (model == null)
            {
                throw new InvalidDataException("model is a required property for CreateChatCompletionFunctionResponse and cannot be null");
            }
            else
            {
                this.Model = model;
            ...
            if (_object == null)
            {
                throw new InvalidDataException("_object is a required property for CreateChatCompletionFunctionResponse and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreateChatCompletionFunctionResponse);
        }

        /// <summary>
        /// Returns true if CreateChatCompletionFunctionResponse instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateChatCompletionFunctionResponse to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateChatCompletionFunctionResponse input)
        {
            if (input == null)
                return false;

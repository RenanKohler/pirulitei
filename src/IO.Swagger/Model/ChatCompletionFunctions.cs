...
namespace IO.Swagger.Model
{
        ...
        public partial class ChatCompletionFunctions :  IEquatable<ChatCompletionFunctions>, IValidatableObject
    {
        ...
        public ChatCompletionFunctions(string description = default(string), string name = default(string), FunctionParameters parameters = default(FunctionParameters))
        {
            // to ensure "name" is required (not null)
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ChatCompletionFunctions and cannot be null");
            }
            else
            {
                this.Name = name;
            ...
            if (parameters == null)
            {
                throw new InvalidDataException("parameters is a required property for ChatCompletionFunctions and cannot be null");
            }
            else
            {

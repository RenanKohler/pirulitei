...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class ChatCompletionRequestAssistantMessageFunctionCall :  IEquatable<ChatCompletionRequestAssistantMessageFunctionCall>, IValidatableObject
    {
        /// <summary>
        ...
        public ChatCompletionRequestAssistantMessageFunctionCall(string arguments = default(string), string name = default(string))
        {
            ...
            if (arguments == null)
            {
                throw new InvalidDataException("arguments is a required property for ChatCompletionRequestAssistantMessageFunctionCall and cannot be null");
            }
            else
            {
            ...
            if (name == null)
            {
                throw new InvalidDataException("name is a required property for ChatCompletionRequestAssistantMessageFunctionCall and cannot be null");
            }
            else
            {
                this.Name = name;
        ...
        {
            return this.Equals(input as ChatCompletionRequestAssistantMessageFunctionCall);
        }

        /// <summary>
        /// Returns true if ChatCompletionRequestAssistantMessageFunctionCall instances are equal
        /// </summary>
        /// <param name="input">Instance of ChatCompletionRequestAssistantMessageFunctionCall to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(ChatCompletionRequestAssistantMessageFunctionCall input)
        {
            if (input == null)
                return false;

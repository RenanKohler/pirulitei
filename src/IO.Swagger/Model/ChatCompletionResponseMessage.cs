...
namespace IO.Swagger.Model
{
        ...
        public partial class ChatCompletionResponseMessage :  IEquatable<ChatCompletionResponseMessage>, IValidatableObject
    {
        ...
        public ChatCompletionResponseMessage(string content = default(string), ChatCompletionMessageToolCalls toolCalls = default(ChatCompletionMessageToolCalls), RoleEnum role = default(RoleEnum), ChatCompletionRequestAssistantMessageFunctionCall functionCall = default(ChatCompletionRequestAssistantMessageFunctionCall))
        {
            // to ensure "content" is required (not null)
            if (content == null)
            {
                throw new InvalidDataException("content is a required property for ChatCompletionResponseMessage and cannot be null");
            }
            else
            {
            ...
            if (role == null)
            {
                throw new InvalidDataException("role is a required property for ChatCompletionResponseMessage and cannot be null");
            }
            else
            {
                this.Role = role;

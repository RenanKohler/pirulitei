...
namespace IO.Swagger.Model
{
    ...
    /// </summary>
    [DataContract]
        public partial class CreateChatCompletionResponseChoices :  IEquatable<CreateChatCompletionResponseChoices>, IValidatableObject
    {
        /// <summary>
        ...
        /// <summary>
        /// Initializes a new instance of the <see cref="CreateChatCompletionResponseChoices" /> class.
        /// </summary>
        ...
        public CreateChatCompletionResponseChoices(FinishReasonEnum finishReason = default(FinishReasonEnum), int? index = default(int?), ChatCompletionResponseMessage message = default(ChatCompletionResponseMessage))
        {
            // to ensure "finishReason" is required (not null)
            if (finishReason == null)
            {
                throw new InvalidDataException("finishReason is a required property for CreateChatCompletionResponseChoices and cannot be null");
            }
            else
            {
            ...
            if (index == null)
            {
                throw new InvalidDataException("index is a required property for CreateChatCompletionResponseChoices and cannot be null");
            }
            else
            {
                this.Index = index;
            ...
            if (message == null)
            {
                throw new InvalidDataException("message is a required property for CreateChatCompletionResponseChoices and cannot be null");
            }
            else
            {
        ...
        {
            return this.Equals(input as CreateChatCompletionResponseChoices);
        }

        /// <summary>
        /// Returns true if CreateChatCompletionResponseChoices instances are equal
        /// </summary>
        /// <param name="input">Instance of CreateChatCompletionResponseChoices to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(CreateChatCompletionResponseChoices input)
        {
            if (input == null)
                return false;

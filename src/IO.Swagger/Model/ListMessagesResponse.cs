...
namespace IO.Swagger.Model
{
        ...
        public partial class ListMessagesResponse :  IEquatable<ListMessagesResponse>, IValidatableObject
    {
        ...
        public ListMessagesResponse(string _object = default(string), List<MessageObject> data = default(List<MessageObject>), string firstId = default(string), string lastId = default(string), bool? hasMore = default(bool?))
        {
            // to ensure "_object" is required (not null)
            if (_object == null)
            {
                throw new InvalidDataException("_object is a required property for ListMessagesResponse and cannot be null");
            }
            else
            {
            ...
            if (data == null)
            {
                throw new InvalidDataException("data is a required property for ListMessagesResponse and cannot be null");
            }
            else
            {
                this.Data = data;
            ...
            if (firstId == null)
            {
                throw new InvalidDataException("firstId is a required property for ListMessagesResponse and cannot be null");
            }
            else
            {
            ...
            if (lastId == null)
            {
                throw new InvalidDataException("lastId is a required property for ListMessagesResponse and cannot be null");
            }
            else
            {
                this.LastId = lastId;
            ...
            if (hasMore == null)
            {
                throw new InvalidDataException("hasMore is a required property for ListMessagesResponse and cannot be null");
            }
            else
            {
